...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/I2Hptwl4gCZLdGmKtDadBI.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/I2Hptwl4gCZLdGmKtDadBI.git > git_output.txt
